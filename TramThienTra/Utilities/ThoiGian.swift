...
enum ThoiGian: Int, CaseIterable {
    ...
    var colors: [Color] {
        switch self {
        case .suongSom:
            // Morning: warm paper white → cream → light tan
        ...
        case .traDenDem:
            // Night: deep plum → dark navy → near-black (not pure black — #141318 minimum)
    ...
    /// Deprecated: was the dark variant. Night theme now handled by traDenDem itself.
