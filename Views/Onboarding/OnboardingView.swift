...
struct OnboardingView: View {
    ...
    private let pages: [OnboardingPage] = [
        ...
        OnboardingPage(
            ...
            subtitle: "Ghi lại 3 điều bạn biết ơn mỗi ngày. Những điều nhỏ bé thường là quý giá nhất.",
            viewType: .drop
        ),
        OnboardingPage(
            title: "Nghi thức Buông bỏ",
            subtitle: "Viết ra những bực dọc, buồn phiền. Rồi buông nó đi — chúng tan theo làn khói trà.",
            viewType: .smoke
        )
    ]
    ...
    var body: some View {
        ZStack {
            ZenColor.zenCream.ignoresSafeArea()
            ...
            VStack(spacing: 0) {
                ...
                // Thin horizontal progress bar (replaces dot indicators)
...
// MARK: - Per-page view with 0.4s fade-in animation on page activation
    ...
    var body: some View {
        VStack(spacing: 32) {
            ...
            Group {
                ...
                case .teaPot: OnboardingTeaPotArt()
                case .drop:   OnboardingDropArt()
                case .smoke:  OnboardingSmokeArt()
                }
            }
