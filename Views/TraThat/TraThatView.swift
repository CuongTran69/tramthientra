    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 0) {
                ...
                // App title — ZenFont.display() (40 pt serif bold)
                Text("Trạm Thiền Trà")
                ...
                // Teapot canvas — 240×240 pt with zenGold.opacity(0.35) drop shadow radius 20
                TraXongView()
                ...
                // Action buttons using ZenButton primary variant
                VStack(spacing: 12) {
                ...
                // Streak summary wrapped in ZenCard
                ZenCard {
