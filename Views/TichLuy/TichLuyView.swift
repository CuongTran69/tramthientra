    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 24) {
                ...
                // Section header with 1 pt zenSage.opacity(0.4) decoration line
...
// MARK: - Legacy GratitudeTextField (backward compatibility)
...
struct GratitudeTextField: View {
    ...
    var body: some View {
        ZenTextField(placeholder: placeholder, text: $text, limit: limit, multiline: true)
    }
}
